            ...
            <div class="container">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30 mt-2 text-center">
                            <h2 class="text-white"><i class="fas fa-user-edit"></i> Registar Form</h2>
                        </div>
                    </div>
                <div class="row">     
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30">
                        <div class="tour-booking-form bg-light">
                                ...
                                <form action="confirm_register.php" method="post" class="w-100">
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="name">First Name</label>
                                                <input id="fname" name="first" type="text" placeholder="First Name" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="name">Last Name</label>
                                                <input id="lname" name="last" type="text" placeholder="Last Name" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="phone" name="phonum" type="text" placeholder="(222) 222-2222" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="mail" type="text" placeholder="xxxx@xxxx.xxx" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="password"> Password</label>
                                                <input id="password" name="psw" type="password"  placeholder="********" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="city" name="city" type="text" placeholder="Your Address" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="credit_num" name="crenum" type="text" placeholder="xxxx-xxxx-xxxx-xxxx" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="passport_no"> Passport No</label>
                                                <input id="passport_no" name="passno" type="text" placeholder="XS1234567" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-5 mb-5">
                                        <button type="submit" name="register_btn" class="btn btn-primary btn-block">Send Your Info</button>
                                    </div>
                                </form>
                            </div>
                        </div>              
