            ...
            <div class="container">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30 mt-2 text-center">
                            <h2 class="text-white"><i class="fas fa-globe"></i> Travel Tour Reservation Form</h2>
                        </div>
                    </div>
                <div class="row">     
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30">
                        <div class="tour-booking-form bg-light">
                                ...
                                <form action="confirm_reserve.php" method="post" class="w-100">
                                    <div class="d-flex">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="datepicker" name="date" type="date" placeholder="yyyy/mm/dd" class="form-control" required>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-5 mb-5">
                                        <button type="submit" name="confirm_btn" class="btn btn-primary btn-block">Confirm your Reservation</button>
                                    </div>
                                </form>
                            </div>
                        </div>              
