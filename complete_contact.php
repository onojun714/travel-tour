...
<html lang="en">
  <head>
    <title>Completely Contact Us</title>
...
<div class="container contact" style="height: 500px;">
	<div class="row">
		<div class="col-md-3">
      ...
      <!-- <form action="travel-action.php" method="post"> -->
          ...
          <!-- <div class="container d-flex h-100 align-items-center"> -->
            <div class="form-group">
                <h4 class="text-black w-75 mx-auto mt-2 mb-2">Your message was successfully sent.</h2>
                <h4 class="text-black w-75 mx-auto mt-2 mb-2">Thank you for your message.</h2>
            </div>
          
            <div class="form-group">        
              <div class="col-sm-offset-2 col-sm-10 text-center">
                    <button class="btn mr-3"><a href="index.php" class="text-white border-none">Top Page</a></button>
                    <button class="btn btn-white"><a  href="index.php#projects" class="text-white border-none">Search</a></button>
              </div>
            </div>
            ...
            <div class="form-group">        
              ...
              <button type="submit" name="send_fb" class="btn btn-default">Submit</button>
              </div>
            </div> -->
          </div>
        <!-- </form> -->
