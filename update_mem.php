<?php
   ...
   $row = $ContactObj->get_one_item($member_id);
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30 mt-2 text-center">
                            <h2 class="text-white"><i class="fas fa-user-edit"></i> Update Form</h2>
                        </div>
                    </div>
                <div class="row">     
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30">
                        <div class="tour-booking-form bg-light">
                                ...
                                <form action="travel-action.php" method="post" class="w-100">
                                    <input type="hidden" name="member_id" valure="<?php echo $member_id ?>">
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="name">First Name</label>
                                                <input id="fname" name="first" type="text" value="<?php echo $row['f_name']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="name">Last Name</label>
                                                <input id="lname" name="last" type="text" value="<?php echo $row['l_name']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $row['birth_day']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="phone"> Phone Number</label>
                                                <input id="phone" name="phonum" type="text" value="<?php echo $row['phone_num']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="mail" type="text" value="<?php echo $row['e_mail']; ?>"class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="password"> Password</label>
                                                <input id="password" name="psw" type="password"  value="<?php echo $row['pass_word']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="city" name="city" type="text" value="<?php echo $row['home_address']; ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="credit_num" name="crenum" type="text" value="<?php echo $row['credit_num']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="passport_no"> Passport No</label>
                                                <input id="passport_no" name="passno" type="text" value="<?php echo $row['passport']; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-5 mb-5">
                                        <button type="submit" name="update_btn" class="btn btn-primary btn-block">Update Your Info</button>
                                    </div>
                                </form>
                            </div>
                        </div>              
