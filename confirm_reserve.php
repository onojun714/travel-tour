...
<html lang="en">
  <head>
    ...
    <style>
        ...
        label { }
        .control-label { font-size: 16px; text-transform: capitalize; color: #20232b; margin-bottom: 8px; letter-spacing: 0px; font-weight: 400; }
        .form-control:focus { }
  ...
  <?php
      $page_flag = 0;
      if (!empty($_POST['reservation_btn'])){
        $page_flag = 1;
      }elseif (!empty($_POST['reservation_btn'])){
        $page_flag = 2;
      }
  ?>
              ...
              <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav ml-auto">
                    ...
                    <?php
                     ...
                     echo '<li class="nav-item"><a class="nav-link js-scroll-trigger" href="login.php">Logout</a></li>';
                    } ?>
                  </ul>
              </div>
          </div>
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30 mt-2 text-center">
                            <h2 class="text-white"><i class="fas fa-globe"></i> Confirm your Reservation</h2>
                        </div>
                    </div>
                <div class="row">     
                        ...
                        <div class="tour-booking-form bg-light">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <h4 class="tour-form-title"><i class="fas fa-plane"></i> Your Travel Plan Detail</h4>
                                    </div>
                                <?php //if(isset($_POST['confirm_btn'])){ ?>
                                <form action="travel-action.php" method="post" class="w-100">
                                    <div class="d-flex">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="select">
                                                    <select id="select" name="destination" class="form-control">
                                                       <option value="<?php echo $_POST['destination']; ?>" selected><?php echo $_POST['destination']; ?></option>
                                                        <!-- <option value="">Where you want to go</option>
                                                        <option value="">---Cultural---</option>
                                                        <option value="Himeji">Himeji Castle</option>
                                                        <option value="Fuji">Mt.Fuji</option>
                                                        <option value="Kyoto">Monuments of Ancient Kyoto</option>
                                                        <option value="Shirakawago">Shirakawago and Gokayama</option>
                                                        <option value="Ithukushima">Itsukushima Shrine</option>
                                                        <option value="Nikko">Shrines and Temples of Nikko</option>
                                                        <option value="">---Natural---</option>
                                                        <option value="Yakushima">Yakushima</option>
                                                        <option value="Shiretoko">Shiretoko</option>
                                                        <option value="Shirakami">Shirakami Sanchi</option>
                                                        <option value="Ogasawara">Ogasawara Islands</option> -->
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label required" for="select">Departure Airport</label>
                                                <div class="select">
                                                    <select id="select" name="airport" class="form-control">
                                                    <option value="<?php echo $_POST['airport']; ?>"selected><?php echo $_POST['airport']; ?></option>
                                                        <!-- <option value="Haneda">Haneda</option>
                                                        <option value="Kansai">Kansai</option>
                                                        <option value="Fukuoka">Fukuoka</option>
                                                        <option value="Shin-Chitose">Shin-Chitose</option>
                                    ...
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <?php echo $_POST['date']; ?>
                                                    <input id="datepicker" name="date" type="hidden" value="<?php echo $_POST['date'] ?>" class="form-control" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label required" for="select">Stay Days:</label>
                                                <div class="select">
                                                    <select id="select" name="stay" class="form-control">
                                                       <!-- <?php echo $_POST['stay']; ?> -->
                                                       <option value="<?php echo $_POST['stay'] ?>" selected><?php echo $_POST['stay'] ?></option>
                                                        <!-- <option value="">Stay Days:</option>
                                    ...
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="select">
                                                    <select id="select" name="persons" class="form-control">
                                                    <option  value="<?php echo $_POST['persons'] ?>" selected><?php echo $_POST['persons'] ?></option>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label required" for="select">Number of Rooms:</label>
                                                <div class="select">
                                                    <select id="select" name="rooms" class="form-control">
                                                    <option  value="<?php echo $_POST['rooms'] ?>" selected><?php echo $_POST['rooms'] ?></option>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <p class="h5"><?php echo $_POST['require']; ?></p>
                                            <input type="hidden" name="require" value="<?php echo $_POST['require'] ?>">
                                            <!-- <textarea class="form-control" id="textarea" name="require" rows="4" placeholder="Write Your Requirements"></textarea> -->
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-5 mb-5">
                                            <button type="submit" name="" class="btn btn-light btn-block">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-5 mb-5">
                                            <button type="submit" name="reservation_btn" class="btn btn-primary btn-block">Send your Reservation</button>
                                        </div>
                                    </div>
                                </form>
